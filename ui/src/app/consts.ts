export class Consts {
    ...
    static readonly API_GET_QUERY_RESULTS: string = 'queryservice/getQueryResults';
    static readonly API_GET_CUSTOM_QUERY_RESULTS: string = 'queryservice/getCustomQueryResults';
